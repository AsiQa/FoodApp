 ...
 * It also controls the visibility of bottom navigation view via [bottomNavVisibility] parameter that is given through one of its subclasses.
...
/**
 * Read only fragment property for getting viwBinding instance. This implementation can be used by calling viewBinding(() -> ViewBinding)
...
class FragmentViewBindingProperty<T : ViewBinding>(private val viewBinder: () -> T) :
    ...
    override fun getValue(thisRef: Fragment, property: KProperty<*>): T {
        ...
        // viewBinding instance has to be set to null if view is destroyed to prevent memory leaks. The implementation uses viewLifecycleOwner to register observer
